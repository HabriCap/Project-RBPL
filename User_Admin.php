...
<html lang="id">
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Menu 1 -->
      <a href="Input_nota.php" style="text-decoration:none; color:inherit;">
      <div class="menu-card">
        <div class="menu-left">
          <div class="menu-icon">
      ...
      <!-- Menu 2 -->
      <a href="input_retur.php" style="text-decoration:none; color:inherit;">
      <div class="menu-card">
        <div class="menu-left">
          <div class="menu-icon">
      ...
      <!-- Menu 3 -->
      <a href="lihat_hasil.php" style="text-decoration:none; color:inherit;">
      <div class="menu-card">
        <div class="menu-left">
          <div class="menu-icon">
      ...
      <!-- Menu 4 -->
      <a href="arsip_nota.php" style="text-decoration:none; color:inherit;">
      <div class="menu-card">
        <div class="menu-left">
          <div class="menu-icon">
            <img src="UI_ADMIN/logo_menu_open.png" alt="" />
